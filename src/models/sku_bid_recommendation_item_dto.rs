...
pub struct SkuBidRecommendationItemDto {
    ...
    #[serde(rename = "bidRecommendations", skip_serializing_if = "Option::is_none")]
    pub bid_recommendations: Option<Vec<crate::models::BidRecommendationItemDto>>,
    /// Рекомендованные цены.
    #[serde(
        rename = "priceRecommendations",
        skip_serializing_if = "Option::is_none"
    )]
    pub price_recommendations: Option<Vec<crate::models::PriceRecommendationItemDto>>,
}
